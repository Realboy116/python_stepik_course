...
'''Случайная строка
Вам доступен текстовый файл lines.txt из нескольких строк. Напишите программу, которая выводит на экран случайную строку
из этого файла.
Формат входных данных
...
# file = open('D:/pythonProject/nums.txt', 'r', encoding='utf-8') мой вариант
# count = 0
# for row in file:
#     count += int(row)
# print(count)
...
# file = open('D:/pythonProject/nums.txt', 'r', encoding='utf-8') вариант учителя
...
# file = open('D:/pythonProject/nums.txt')
# s = file.read().split()
# print(sum(map(int, s)))
# file.close()
...
# file = open('prices.txt')             вариант 1
# ls = file.readlines()
# result = 0
# for row in ls:
...
# tov = open('D:/pythonProject/price.txt')    вариант 2
# print(sum(map(lambda x: int(x[1]) * int(x[2]), [i.split() for i in tov])))
