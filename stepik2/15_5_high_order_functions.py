...
# new_ls = map(f, numbers)
# print(*map(f, new_ls), sep='\n')
...
# print(*map(cub, filter(three_n, numbers)), sep='\n')
...
# print(sum(map(kv, filter(two_n, numbers))))
...
#     res = [func(c) for c in items]
#     return res

# n = [1, 2, 3]          это для примера к заданию не относится
